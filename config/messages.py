...
```"""
    ...
    report_message_spam_title = "Report #{id} - Spam"
    ...
    report_message_spam = "### Označen jako spam uživatelem {author} `@{author_name}`"
    report_message_not_spam = "### Označení jako spam bylo zrušeno uživatelem {author} `@{author_name}`"
