...
class Messages(metaclass=Formatable):
    ...
    channel_role_to_overwrites_start = "Probíhá převádění přístupových práv na roli"
    channel_role_to_overwrites_done = "Přístupová práva byla úspěšně převedena na roli"
...
```"""
    ...
    report_message_already_deleted = "### Reported message was already deleted @{author}"
    report_message_deleted = "### Reported message deleted by @{author}"
