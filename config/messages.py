...
class Messages(metaclass=Formatable):
    ...
    contest_successful_deletion = "Příspěvek byl úspěšně odmítnut a důvod odeslán uživateli."
    contest_successful_deletion_no_reason = "Příspěvek byl odmítnut. Důvod nebyl odeslán uživateli."
