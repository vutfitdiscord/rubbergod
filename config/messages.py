...
```"""
    ...
    report_message_already_deleted = "### Nahlášená zpráva nebyla nalezena nebo byla smazána @{author}"
    report_message_deleted = "### Nahlášená zpráva byla smazána uživatelem @{author}"
